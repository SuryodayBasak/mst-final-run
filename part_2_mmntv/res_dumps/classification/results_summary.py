...
def show_res(df, op, sw):
    ...
    elif op == 'xx' and (sw == 'dknn' or sw == ' dknn'):
        m_name = 'D-KNN'
    
    elif op == 'pca' and sw == 'dknn':
        m_name = 'PCA-D-KNN'

    elif op == 'pca' and sw == 'knn':
        m_name = 'PCA-KNN'
    ...
    print('&', m_name,\
          '&',round(res_list[0] * 100, 2),\
          '&',round(res_list[1] * 100, 2),\
          '&',round(res_list[2] * 100, 2),\
          '&',round(res_list[3] * 100, 2),\
          '&',round(res_list[4] * 100, 2),\
          '&',round(res_list[5] * 100, 2),\
          '&',round(res_list[6] * 100, 2),\
          '\\\\')
